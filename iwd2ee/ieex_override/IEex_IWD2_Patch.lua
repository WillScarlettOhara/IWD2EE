...
IEex_Normal_Patch_Files = {
	...
	"override/IEex_HDTiles_Patch.lua",
	"override/IEex_CameraZoom_Patch.lua",
	"override/IEex_Markers_Patch.lua",
	"override/IEex_UIScale_Patch.lua",
	"override/IEex_SupersampleFont_Patch.lua",
	"override/IEex_HDSprites_Patch.lua",
	...
	"override/IEex_Pathfinding_Patch.lua",
