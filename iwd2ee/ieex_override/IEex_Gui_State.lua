...
function IEex_InjectOptionIniComments()
	...
	local comments = {
		...
		["IP Personal Space Reduce"]              = "Improved Pathfinding EXPERIMENTAL: shrink every creature's search-map collision footprint one step (humanoids: 3x3 cells -> 1) so tight corridors jam less - BOTH sides, so door body-blocking weakens. Attack/dialogue/cast ranges keep vanilla spacing. Boot-time patch - changing it requires a full restart. Default off.",
